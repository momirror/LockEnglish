...
/** 
 * DAO for table "CETENTITY".
*/
public class CETEntityDao extends AbstractDao<CETEntity, Void> {

    public static final String TABLENAME = "CETENTITY";

    /**
     * Properties of entity CETEntity.<br/>
    ...
    */
    ...
    public CETEntityDao(DaoConfig config) {
        super(config);
    }
    
    public CETEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CETENTITY\" (" + //
                "\"WORD\" TEXT," + // 0: word
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CETENTITY\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CETEntity entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CETEntity readEntity(Cursor cursor, int offset) {
        CETEntity entity = new CETEntity( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CETEntity entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(CETEntity entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(CETEntity entity) {
        return null;
    }
